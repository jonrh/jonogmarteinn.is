  ...
  return (
    <>
      <p className="lead">
        ...
        {jonYearsOfExperience} ára reynslu af málun. Marteinn hefur starfað sem málari í{" "}
        {marteinnYearsOfExperience} ár. Saman stofnuðu þeir fyrirtækið Jón og Marteinn
        Málningarþjónusta ehf.
      </p>

      <p className="lead">
        Fyrirtækið tekur að sér öll almenn verk þar sem þarf að mála. Verkefni stór sem smá,
        sérsniðið að óskum og þörfum og hvar sem er á landinu. Höfum einnig tekið að okkur verkefni
        erlendis. Hjá fyrirtækinu starfa samtals 10 málarar meðtalið Jóni og Marteini.
      </p>
    </>
  );
}
